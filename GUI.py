...
root = Tk()
root.title("THE REPLICA IDENTIFIER")
...
resultLabel = Label(text="THE REPLICA IDENTIFIER", font=("Times New Roman", 50))
...
quitButton = ttk.Button(text="Exit program", style = 'W.TButton', command=close)
